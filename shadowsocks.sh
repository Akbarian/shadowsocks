...
#   Author: ALireza Akbarian <a.akbariyan@gmail.com>              #
#=================================================================#
...
echo "# Author: Alireza Akbarian <a.akbariyan@gmail.com>                         #"
...
pre_install(){
    ...
    read -p "(Default password: alireza):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="alireza"
    echo
    echo "---------------------------"
